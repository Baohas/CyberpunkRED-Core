  ...
  static async RenderPrompt(data) {
    ...
    return new Promise((resolve, reject) => {
      renderTemplate(
        ...
        const _onCancel = () => {
          LOGGER.trace(
            "_onCancel | Dialog ContainerVendorPurchaseOrderPrompt | called."
          );
        ...
        const _onConfirm = () => {
          LOGGER.trace(
            "_onConfirm | Dialog ContainerVendorPurchaseOrderPrompt | called."
          );
          resolve(true);
        };
        new Dialog({
          ...
          buttons: {
            ...
            cancel: {
              ...
              label: SystemUtils.Localize(
                "CPR.dialog.container.vendor.decline"
              ),
              callback: () => _onCancel(),
            },
          },
          default: "confirm",
          render: LOGGER.trace(
            "confirm | Dialog ContainerVendorPurchaseOrderPrompt | called."
          ),
          close: () => {
            reject(new Error("Promise rejected: Window Closed"));
          },
