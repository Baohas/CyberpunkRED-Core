...
// Sorted A-Z
CPR.skillList = {
  athletics: "CPR.global.skill.athletics",
  basicTech: "CPR.global.skill.basicTech",
  brawling: "CPR.global.skill.brawling",
  bribery: "CPR.global.skill.bribery",
  concentration: "CPR.global.skill.concentration",
  conversation: "CPR.global.skill.conversation",
  cyberTech: "CPR.global.skill.cybertech",
  education: "CPR.global.skill.education",
  evasion: "CPR.global.skill.evasion",
  firstAid: "CPR.global.skill.firstAid",
  humanPerception: "CPR.global.skill.humanPerception",
  interrogation: "CPR.global.skill.interrogation",
  localExpert: "CPR.global.skill.localExpert",
  meleeWeapon: "CPR.global.skill.meleeWeapon",
  perception: "CPR.global.skill.perception",
  persuasion: "CPR.global.skill.persuasion",
  playInstrument: "CPR.global.skill.playInstrument",
  stealth: "CPR.global.skill.stealth",
  tracking: "CPR.global.skill.tracking",
  accounting: "CPR.global.skill.accounting",
  acting: "CPR.global.skill.acting",
  airVehicleTech: "CPR.global.skill.airVehicleTech",
  animalHandling: "CPR.global.skill.animalHandling",
  archery: "CPR.global.skill.archery",
  autofire: "CPR.global.skill.autofire",
  bureaucracy: "CPR.global.skill.bureaucracy",
  business: "CPR.global.skill.business",
  composition: "CPR.global.skill.composition",
  concealOrRevealObject: "CPR.global.skill.concealOrRevealObject",
  contortionist: "CPR.global.skill.contortionist",
  criminology: "CPR.global.skill.criminology",
  cryptography: "CPR.global.skill.cryptography",
  dance: "CPR.global.skill.dance",
  deduction: "CPR.global.skill.deduction",
  demolitions: "CPR.global.skill.demolitions",
  driveLandVehicle: "CPR.global.skill.driveLandVehicle",
  electronicsAndSecurityTech: "CPR.global.skill.electronicsAndSecurityTech",
  endurance: "CPR.global.skill.endurance",
  forgery: "CPR.global.skill.forgery",
  gamble: "CPR.global.skill.gamble",
  handgun: "CPR.global.skill.handgun",
  heavyWeapons: "CPR.global.skill.heavyWeapons",
  landVehicleTech: "CPR.global.skill.landVehicleTech",
  language: "CPR.global.skill.language",
  librarySearch: "CPR.global.skill.librarySearch",
  lipReading: "CPR.global.skill.lipReading",
  martialArts: "CPR.global.skill.martialArts",
  paintOrDrawOrSculpt: "CPR.global.skill.paintOrDrawOrSculpt",
  paramedic: "CPR.global.skill.paramedic",
  personalGrooming: "CPR.global.skill.personalGrooming",
  photographyAndFilm: "CPR.global.skill.photographyAndFilm",
  pickLock: "CPR.global.skill.pickLock",
  pickPocket: "CPR.global.skill.pickPocket",
  pilotAirVehicle: "CPR.global.skill.pilotAirVehicle",
  pilotSeaVehicle: "CPR.global.skill.pilotSeaVehicle",
  resistTortureOrDrugs: "CPR.global.skill.resistTortureOrDrugs",
  riding: "CPR.global.skill.riding",
  science: "CPR.global.skill.science",
  seaVehicleTech: "CPR.global.skill.seaVehicleTech",
  shoulderArms: "CPR.global.skill.shoulderArms",
  streetWise: "CPR.global.skill.streetwise",
  tactics: "CPR.global.skill.tactics",
  trading: "CPR.global.skill.trading",
  wardrobeAndStyle: "CPR.global.skill.wardrobeAndStyle",
  weaponsTech: "CPR.global.skill.weaponstech",
  wildernessSurvival: "CPR.global.skill.wildernessSurvival",
};

// Unsorted
CPR.skillDifficulties = {
  typical: "CPR.global.skill.difficulty.typical",
  difficult: "CPR.global.skill.difficulty.difficult",
  role: "CPR.global.skill.difficulty.role",
};
...
CPR.upgradableDataPoints = {
  ...
  clothing: {
    "Wardrobe & Style": {
      type: "modifier",
      value: 0,
      localization: "CPR.global.skill.wardrobeAndStyle",
    },
    cool: {
      type: "modifier",
      value: 0,
...
CPR.activeEffectKeys = {
  ...
  skill: {
    ...
    "bonuses.accounting": "CPR.global.skill.accounting",
    "bonuses.acting": "CPR.global.skill.acting",
    "bonuses.airVehicleTech": "CPR.global.skill.airVehicleTech",
    "bonuses.animalHandling": "CPR.global.skill.animalHandling",
    "bonuses.archery": "CPR.global.skill.archery",
    "bonuses.athletics": "CPR.global.skill.athletics",
    "bonuses.autofire": "CPR.global.skill.autofire",
    "bonuses.basicTech": "CPR.global.skill.basicTech",
    "bonuses.brawling": "CPR.global.skill.brawling",
    "bonuses.bribery": "CPR.global.skill.bribery",
    "bonuses.bureaucracy": "CPR.global.skill.bureaucracy",
    "bonuses.business": "CPR.global.skill.business",
    "bonuses.composition": "CPR.global.skill.composition",
    "bonuses.concealOrRevealObject": "CPR.global.skill.concealOrRevealObject",
    "bonuses.concentration": "CPR.global.skill.concentration",
    "bonuses.contortionist": "CPR.global.skill.contortionist",
    "bonuses.conversation": "CPR.global.skill.conversation",
    "bonuses.criminology": "CPR.global.skill.criminology",
    "bonuses.cryptography": "CPR.global.skill.cryptography",
    "bonuses.cybertech": "CPR.global.skill.cybertech",
    "bonuses.dance": "CPR.global.skill.dance",
    "bonuses.deduction": "CPR.global.skill.deduction",
    "bonuses.demolitions": "CPR.global.skill.demolitions",
    "bonuses.driveLandVehicle": "CPR.global.skill.driveLandVehicle",
    "bonuses.education": "CPR.global.skill.education",
    "bonuses.electronicsAndSecurityTech": "CPR.global.skill.electronicsAndSecurityTech",
    "bonuses.endurance": "CPR.global.skill.endurance",
    "bonuses.evasion": "CPR.global.skill.evasion",
    "bonuses.firstAid": "CPR.global.skill.firstAid",
    "bonuses.forgery": "CPR.global.skill.forgery",
    "bonuses.gamble": "CPR.global.skill.gamble",
    "bonuses.handgun": "CPR.global.skill.handgun",
    "bonuses.heavyWeapons": "CPR.global.skill.heavyWeapons",
    "bonuses.humanPerception": "CPR.global.skill.humanPerception",
    "bonuses.interrogation": "CPR.global.skill.interrogation",
    "bonuses.landVehicleTech": "CPR.global.skill.landVehicleTech",
    "bonuses.language": "CPR.global.skill.language",
    "bonuses.librarySearch": "CPR.global.skill.librarySearch",
    "bonuses.lipReading": "CPR.global.skill.lipReading",
    "bonuses.localExpert": "CPR.global.skill.localExpert",
    "bonuses.martialArts": "CPR.global.skill.martialArts",
    "bonuses.meleeWeapon": "CPR.global.skill.meleeWeapon",
    "bonuses.paintOrDrawOrSculpt": "CPR.global.skill.paintOrDrawOrSculpt",
    "bonuses.paramedic": "CPR.global.skill.paramedic",
    "bonuses.perception": "CPR.global.skill.perception",
    "bonuses.personalGrooming": "CPR.global.skill.personalGrooming",
    "bonuses.persuasion": "CPR.global.skill.persuasion",
    "bonuses.photographyAndFilm": "CPR.global.skill.photographyAndFilm",
    "bonuses.pickLock": "CPR.global.skill.pickLock",
    "bonuses.pickPocket": "CPR.global.skill.pickPocket",
    "bonuses.pilotAirVehicle": "CPR.global.skill.pilotAirVehicle",
    "bonuses.pilotSeaVehicle": "CPR.global.skill.pilotSeaVehicle",
    "bonuses.playInstrument": "CPR.global.skill.playInstrument",
    "bonuses.resistTortureOrDrugs": "CPR.global.skill.resistTortureOrDrugs",
    "bonuses.riding": "CPR.global.skill.riding",
    "bonuses.science": "CPR.global.skill.science",
    "bonuses.seaVehicleTech": "CPR.global.skill.seaVehicleTech",
    "bonuses.shoulderArms": "CPR.global.skill.shoulderArms",
    "bonuses.stealth": "CPR.global.skill.stealth",
    "bonuses.streetWise": "CPR.global.skill.streetwise",
    "bonuses.tactics": "CPR.global.skill.tactics",
    "bonuses.tracking": "CPR.global.skill.tracking",
    "bonuses.trading": "CPR.global.skill.trading",
    "bonuses.wardrobeAndStyle": "CPR.global.skill.wardrobeAndStyle",
    "bonuses.weaponstech": "CPR.global.skill.weaponstech",
    "bonuses.wildernessSurvival": "CPR.global.skill.wildernessSurvival",
  },
  stat: {
