...
export default function preloadHandlebarsTemplates() {
  ...
  return loadTemplates([
    ...
    `systems/${game.system.id}/templates/actor/cpr-character-sheet.hbs`,
    `systems/${game.system.id}/templates/actor/cpr-container-sheet.hbs`,
    `systems/${game.system.id}/templates/actor/cpr-demon-sheet.hbs`,
    `systems/${game.system.id}/templates/actor/cpr-mook-sheet-limited.hbs`,
    `systems/${game.system.id}/templates/actor/cpr-mook-sheet.hbs`,

    // Character: Left Pane Partials
    ...
    // Character: Bottom Pane Partials
    ...
    // Character: Skill Tab Partials
    `systems/${game.system.id}/templates/actor/character/right-pane/parts/skills/cpr-skills-category.hbs`,

    // Character: Gear Tab Partials
    `systems/${game.system.id}/templates/actor/character/right-pane/parts/gear/cpr-ammo-content.hbs`,
    `systems/${game.system.id}/templates/actor/character/right-pane/parts/gear/cpr-armor-content.hbs`,
    `systems/${game.system.id}/templates/actor/character/right-pane/parts/gear/cpr-clothing-content.hbs`,
    `systems/${game.system.id}/templates/actor/character/right-pane/parts/gear/cpr-cyberdeck-content.hbs`,
    `systems/${game.system.id}/templates/actor/character/right-pane/parts/gear/cpr-cyberware-content.hbs`,
    `systems/${game.system.id}/templates/actor/character/right-pane/parts/gear/cpr-cyberware-content.hbs`,
    `systems/${game.system.id}/templates/actor/character/right-pane/parts/gear/cpr-drug-content.hbs`,
    `systems/${game.system.id}/templates/actor/character/right-pane/parts/gear/cpr-gear-content.hbs`,
    `systems/${game.system.id}/templates/actor/character/right-pane/parts/gear/cpr-itemUpgrade-content.hbs`,
    `systems/${game.system.id}/templates/actor/character/right-pane/parts/gear/cpr-program-content.hbs`,
    `systems/${game.system.id}/templates/actor/character/right-pane/parts/gear/cpr-program-content.hbs`,
    `systems/${game.system.id}/templates/actor/character/right-pane/parts/gear/cpr-vehicle-content.hbs`,
    `systems/${game.system.id}/templates/actor/character/right-pane/parts/gear/cpr-weapon-content.hbs`,

    // Character: Cyberware Tab Partials
    `systems/${game.system.id}/templates/actor/character/right-pane/parts/cyberware/cpr-cyberware-content.hbs`,
    `systems/${game.system.id}/templates/actor/character/right-pane/parts/cyberware/cpr-cyberware-header.hbs`,

    // Character: Debug
    `systems/${game.system.id}/templates/actor/character/debug/cpr-item-debug.hbs`,

    // Actor: Common Partials / Actions
    `systems/${game.system.id}/templates/actor/common/actions/cpr-actions.hbs`,
    `systems/${game.system.id}/templates/actor/common/actions/cpr-dv-glyph.hbs`,
    `systems/${game.system.id}/templates/actor/common/actions/cpr-equip-glyph.hbs`,
    `systems/${game.system.id}/templates/actor/common/actions/cpr-install-cyberware-glyph.hbs`,
    `systems/${game.system.id}/templates/actor/common/actions/cpr-install-programs-glyph.hbs`,
    `systems/${game.system.id}/templates/actor/common/actions/cpr-reload-glyph.hbs`,
    `systems/${game.system.id}/templates/actor/common/actions/cpr-repair-glyph.hbs`,
    `systems/${game.system.id}/templates/actor/common/actions/cpr-snort-glyph.hbs`,
    `systems/${game.system.id}/templates/actor/common/actions/cpr-split-item.hbs`,
    `systems/${game.system.id}/templates/actor/common/actions/cpr-uninstall-glyph.hbs`,
    `systems/${game.system.id}/templates/actor/common/actions/cpr-upgrade-glyph.hbs`,
